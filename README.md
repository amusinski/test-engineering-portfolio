...
- **[Jira Ticket 6774 — Excel Serial Date Inputs Causing Payment Upload 500s.md](case_studies/jira_ticket_review_agent/jira_ticket_6774.md)**  
...
- **[Jira Ticket 521 — Manual Test Case Set: Remove Cancel/Update Buttons in View Mode.md](case_studies/test_case_generator/jira_ticket_521.md)**  
  Validates View vs Edit-mode controls, validation safety (no data loss), persistence, and role-based access.

- **[Jira Story 6753 — Manual Test Case Set: Subclaim Snapshot JSON Field Creation.md](case_studies/test_case_generator/jira_ticket_6753.md)**  
